...
Singleton {
  ...
  readonly property var priorityRules: [
    ...
    { rank: 12, re: /floating \/ tiling/i },
    { rank: 13, re: /^focus /i },
    { rank: 14, re: /^move window (left|right|up|down)$/i },
    { rank: 15, re: /^swap window /i },
    { rank: 16, re: /^move workspace to .* monitor$/i },
    { rank: 17, re: /resize|expand window|shrink window/i },
    { rank: 18, re: /^save window width$/i },
    { rank: 19, re: /^restore saved window width$/i },
    { rank: 20, re: /^split /i },
    { rank: 21, re: /^workspace [0-9]+$/i },
    { rank: 22, re: /^move silently to workspace [0-9]+$/i },
    { rank: 23, re: /^move to workspace [0-9]+$/i },
    { rank: 24, re: /^move silently to (next|previous) workspace$/i },
    { rank: 25, re: /^next workspace$/i },
    { rank: 26, re: /^previous workspace$/i },
    { rank: 27, re: /^former workspace$/i },
    { rank: 28, re: /^move to (next|previous) workspace$/i },
    { rank: 29, re: /^universal (copy|cut|paste)$/i },
    { rank: 30, re: /^clipboard history$/i },
    { rank: 31, re: /^calculator$/i },
    { rank: 32, re: /^transcode media$/i },
    ...
    { rank: 46, re: /^files here/i },
    { rank: 47, re: /^screenshot/i },
    { rank: 48, re: /^screen recording$/i },
    { rank: 49, re: /^colour picker$/i },
    { rank: 50, re: /^extract text$/i },
    { rank: 51, re: /^capture menu$/i },
    { rank: 52, re: /^toggle webcam overlay$/i },
    { rank: 53, re: /^webcam overlay (smaller|larger)$/i },
    { rank: 54, re: /^dismiss newest notification$/i },
    { rank: 55, re: /^dismiss all notifications$/i },
    { rank: 56, re: /^toggle do not disturb$/i },
    { rank: 57, re: /^invoke newest notification$/i },
    { rank: 58, re: /^notification history$/i },
    { rank: 59, re: /^desktop modes$/i },
    { rank: 60, re: /^stay awake$/i },
    { rank: 61, re: /^toggle menu /i },
    { rank: 62, re: /^(start|toggle automatic) ASCII screensaver$/i },
    { rank: 63, re: /^lock screen$/i },
    { rank: 64, re: /^toggle network panel$/i },
    { rank: 65, re: /^toggle display panel$/i },
    { rank: 66, re: /^toggle media panel$/i },
    { rank: 67, re: /^toggle audio panel$/i },
    { rank: 68, re: /^toggle Bluetooth panel$/i },
    { rank: 69, re: /^manage Wi-Fi and network$/i },
